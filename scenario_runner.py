...
def run_scenario_from_row(scenario_row, price_profiles, load_profiles, emissions_profiles, charge_set):
    """
    ...
    emissions_id = scenario_row['Emissions Region ID']
    ...
    emissions_profiles[emissions_id] = pd.to_numeric(emissions_profiles[emissions_id])
